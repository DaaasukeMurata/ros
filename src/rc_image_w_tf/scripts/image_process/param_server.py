...
class ParamServer():
    ...
    __params['color.low_b'] = LinearParam(value=12, lower=0, upper=255)
    __params['color.low_g'] = LinearParam(value=66, lower=0, upper=255)
    __params['color.low_r'] = LinearParam(value=4, lower=0, upper=255)
    __params['color.high_b'] = LinearParam(value=255, lower=0, upper=255)
    __params['color.high_g'] = LinearParam(value=132, lower=0, upper=255)
    __params['color.high_r'] = LinearParam(value=118, lower=0, upper=255)
